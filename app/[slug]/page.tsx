...
const CodeCopyButton = dynamic(
  () => import("@/app/[slug]/_components/code-copy-button")
);

// TableOfContentsを遅延ロード（XL以上でのみ表示、TBT改善のため）
const TableOfContents = dynamic(
  () => import("@/app/[slug]/_components/table-of-contents")
);
          ...
          <div className="flex gap-12">
            ...
            <article className="flex-1 min-w-0">
              ...
              <div
                ...
                prose-code:text-purple-600 prose-code:dark:text-purple-400 prose-code:bg-gray-100 prose-code:dark:bg-gray-800 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-sm prose-code:before:content-[''] prose-code:after:content-['']
